						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<input type="button" value="주소찾기" onclick="findAddr()" class="btn btn-light">
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<input type="submit" class="btn btn-light" value="회원정보수정">
									<input type="reset" class="btn btn-light" value="취소">
									<c:if test="${sid=='admin' }">
									<a href="${path1 }/member/delete.do?id=${member.id }" class="btn btn-light">직권 강퇴</a>
									</c:if>
									<c:if test="${sid!='admin' }">
									<a href="${path1 }/member/delete.do?id=${sid }" class="btn btn-light">회원 탈퇴</a>
									</c:if>
									<c:if test="${sid=='admin' }">
									<a href="${path1 }/member/list.do" class="btn btn-light">회원 목록</a>
									</c:if>
								</td>
							</tr>	
						</tbody>
